                ...
                <table className="w-full border-collapse border border-gray-300 text-sm text-left">
                    <thead>
                        <tr>
                            ...
                            <th className="border border-gray-300 font-medium p-2">Amount</th>
                        ...
                        {isLoading ? (
                            ...
                            paginatedData.map((order, index) => (
                                <tr key={index} className="hover:bg-gray-50">
                                    ...
                                    <td className="border border-gray-300 p-2 whitespace-nowrap font-light">{order?.gstAmount}</td>
                                    <td className="border border-gray-300 p-2 whitespace-nowrap font-light">{order?.shippingAmount}</td>
                                    <td className="border border-gray-300 p-2 whitespace-nowrap font-light">{order?.sponsorBonus}</td>
                                    ...
                                    <td className="border border-gray-300 p-2">{order?.orderStatuses}</td>
